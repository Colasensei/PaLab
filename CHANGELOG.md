...
## Alpha 7.7（正式版）— 2026-08-15
- 设置新增「渲染分辨率」档位（原始 / 75% / 50%）：仅 Android 与 Windows 桌面端显示并真正生效，低端设备更流畅
- 手动锁定渲染分辨率后不再参与自动降档；浏览器版本不显示该选项

## Alpha 7.6（正式版）— 2026-08-15
...
## Alpha 7.1（紧急修复）— 2026-08-12
- 紧急修复快照
- 修复游玩中音符凭空消失（同屏音符上限提升、已判定音符更快移出渲染窗口）
- 界面大小 / 游戏界面大小新增极小档（60%）

## Alpha 7.0（正式版）— 2026-08-12
...
## Alpha 5.2（正式版）— 2026-07-29
- 修复 import.meta.env 生产构建兼容性
- 准度条红区缩小、素材修复直链
- 更新系统 lingyanspace 升级托管

## Alpha 5.1（正式版）— 2026-07-29
- 准度条红区大幅缩小（10%），绿黄占比增大
- 素材修复切换至升级托管服务直链
- 更新系统完善（进度条+速度+错误详情）

## Alpha 5.0（正式版）— 2026-07-29
- 更新系统切换至 lingyanspace 升级托管服务
- 下载进度条 + 速度显示 + 错误详情
- 素材修复云端下载 + 检查更新完善

## Alpha 4.7（正式版）— 2026-07-29
- 素材修复改为云端一键下载（七牛云）
- 新增更新检查系统（主菜单按钮 + 自动检测）
- 打击音效延迟优化、高密度渲染修复

## Alpha 4.6（正式版）— 2026-07-29
- 素材修复改为云端一键下载（七牛云）
- 新增更新检查系统（主菜单按钮 + 自动检测）
- perf_maxVisibleNotes 默认提升至 1000

## Alpha 4.5（正式版）— 2026-07-29
- 修复高密度谱面渲染停止恶性 bug
- 完善帮助页面（编辑器、准度条、正解音）

## Alpha 4.4（正式版）— 2026-07-28
